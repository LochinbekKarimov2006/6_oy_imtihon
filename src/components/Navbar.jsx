...
function Navbar() {
  ...
  return (
    <div >
        <div className=" mb-20  navbar bg-base-100 drop-shadow-lg w-full">
  <div className="navbar-start">
    <div className="dropdown">
      <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
      </div>
      <ul tabIndex={0} className="menu uil menu-sm dropdown-content mt-3 z-[0] p-2 shadow bg-base-100 rounded-box w-52">
        <li><NavLink to='/'>Home</NavLink></li>
        <li><NavLink to='/about'>Abaut</NavLink></li>
  ...
  <input onClick={()=>{thema()}} checked={rejim=='dark'} readOnly type="checkbox" className="theme-controller" value="synthwave" />
    ...
    <div className="dropdown dropdown-end">
      <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
        <div className="w-10 rounded-full">
            <NavLink onClick={()=>{chiqibKetish()}} to='/haridlar'>
